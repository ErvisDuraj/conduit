      ...
      <Layout.Sider
        ...
        <div className="sidebar">
          ...
          <Menu
            ...
            <Menu.Item className="sidebar-menu-item" key="/graph">
              <Icon><ConduitLink to="/graph"><Icon type="share-alt" /></ConduitLink></Icon>
              <span><ConduitLink to="/graph">Network Graph</ConduitLink></span>
            </Menu.Item>
